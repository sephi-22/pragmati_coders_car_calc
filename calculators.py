...
def get_car_mileage(state_prices):
    fuel_type = input("Enter the fuel type of the car (regular/mid_grade/premium/diesel): ")
    cost_per_gallon = 0  
    ...
    return months_to_75k, monthly_gas_cost
...
def get_monthly_interest_payment():
    ...
    resale_value = float(input("Enter the resale value of the car, 0 if you don't plan on selling it later: "))
    ...
    amount_owed = principal - down_payment - resale_value
    tax = tax/100
    amount_owed = amount_owed + amount_owed*tax
